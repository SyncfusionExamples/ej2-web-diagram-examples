...
- Create Angular project with ng: `ng new diagram_mysql.client --defaults --skip-install --skip-git `.
...
- Create project file (`diagram_mysql.client.esproj`).
...
- Update progrixy endpoint to be the backend server endpoint.
