...
- **Frontend**: Angular + TypeScript + Syncfusion Diagrams
- **Backend**: Node.js + Express + TypeScript
- **Database**: PostgreSQL

The application fetches organizational hierarchy data from a PostgreSQL database and renders it as an interactive diagram using Syncfusion's Angular Diagram component.
