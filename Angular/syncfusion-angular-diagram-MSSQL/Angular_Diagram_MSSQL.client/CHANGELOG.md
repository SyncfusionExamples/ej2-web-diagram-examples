...
- Create Angular project with ng: `ng new angular_diagram_MSSQL.client --defaults --skip-install --skip-git `.
...
- Create project file (`angular_diagram_MSSQL.client.esproj`).
