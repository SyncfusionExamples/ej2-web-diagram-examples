...
To get started you need to clone the `mysql_diagram.client` repository and navigate to `mysql_diagram.client` location.

```
git clone https://github.com/syncfusion/mysql_diagram.client.git quickstart
cd quickstart
```
